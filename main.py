...
def init():
    global screen, screen_rect, screen_backdrop
    pygame.init()
    pygame.display.set_caption(c.CAPTION)
    screen = pygame.display.set_mode(c.SCREEN_SIZE)
    screen_backdrop = pygame.image.load(os.path.join("sources","images", "menu.png")).convert()
...
class Game:
    ...
    def start(self):
        ...
        while not self.done:
            self.event_loop()
            pygame.display.flip()
            screen.blit(screen_backdrop, screen_rect)
