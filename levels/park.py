...
class Park(State):
    ...
    def set_blocks(self):
        ...
        block123 = Block(1000, 400, 'park')
        block124 = Block(1160, 400, 'park')
        block125 = Block(2200, 400, 'park')
        block126 = Block(2360, 400, 'park')
        block127 = Block(2520, 400, 'park')
        block128 = Block(2760, 400, 'park')
        block129 = Block(3000, 400, 'park')
        block130 = Block(3880, 400, 'park')
        block131 = Block(3920, 400, 'park')
        block132 = Block(3960, 400, 'park')
        block133 = Block(4000, 400, 'park')
        block134 = Block(4160, 400, 'park')
        block135 = Block(4200, 400, 'park')
        block136 = Block(4240, 400, 'park')
        block137 = Block(4280, 400, 'park')
        block138 = Block(4320, 400, 'park')
        block139 = Block(360, 440, 'park')
        block140 = Block(400, 440, 'park')
        block141 = Block(1080, 440, 'park')
        block142 = Block(1520, 440, 'park')
        block143 = Block(1720, 440, 'park')
        block144 = Block(2200, 440, 'park')
        block145 = Block(2360, 440, 'park')
        block146 = Block(2520, 440, 'park')
        block147 = Block(3000, 440, 'park')
        block148 = Block(4040, 440, 'park')
        block149 = Block(360, 480, 'park')
        block150 = Block(600, 480, 'park')
        block151 = Block(680, 480, 'park')
        block152 = Block(760, 480, 'park')
        block153 = Block(1040, 480, 'park')
        block154 = Block(1120, 480, 'park')
        block155 = Block(1720, 480, 'park')
        block156 = Block(2280, 480, 'park')
        block157 = Block(2440, 480, 'park')
        block158 = Block(2840, 480, 'park')
        block159 = Block(3000, 480, 'park')
        block160 = Block(3800, 480, 'park')
        block161 = Block(4080, 480, 'park')
        block162 = Block(4240, 480, 'park')
